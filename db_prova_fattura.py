...
c.execute('''
CREATE TABLE IF NOT EXISTS orders_fattura_newfields (
    invoice_number TEXT,
    number TEXT,
    Date_1 TEXT,
    customer_phone TEXT,
    ...
    product_discount_2 REAL,
    product_discount_3 REAL,
    product_amount REAL,
...
orders_fattura_data = [
    (
        ...
        'ART001', 'Product 1 Description', 10, 100.50, 5,5,5, 95.50, 10, 955, 210, 'DHL', 'Recipient Name', 1355
    ),
    (
        ...
        'ART002', 'Product 2 Description', 5, 50.00, 0,5,5, 50.00, 5, 250, 55, 'DHL', 'Recipient Name', 360
    ),
    (
        ...
        'ART003', 'Product 3 Description', 20, 200.00, 10,5,5, 180.00, 20, 3600, 792, 'DHL', 'Recipient Name', 5184
    ),
(
        ...
        'ART004', 'Product 4 Description', 15, 150.00, 0,5,5, 150.00, 15, 2250, 495, 'UPS', 'Recipient Name', 2745
    ),
    (
        ...
        'ART005', 'Product 5 Description', 8, 80.00, 5,5,5, 76.00, 8, 608, 134, 'DHL', 'Recipient Name', 742
    ),
    (
        ...
        'ART006', 'Product 6 Description', 12, 120.00, 8,5,5, 110.40, 12, 1324.8, 291.46, 'UPS', 'Recipient Name', 1616.26
    )
...
c.executemany('''
INSERT INTO orders_fattura_newfields (
    ...
    product_price, product_discount,product_discount_2, product_discount_3, product_amount,
