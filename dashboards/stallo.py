...
def show_dashboard8(parent_frame):
    ...
    filter_frame.pack(pady=5, padx=5, fill="x")z
    global combobox
    ...
    def generate_non_sold_pdf(order):
        ...
        def edit_and_confirm():
            ...
            popup.geometry("800x700")  # Set the size of the popup window
            popup.resizable(True, True)  # Prevent resizing for consistent layout
    ...
    def create_invoice_xml(id_trasmittente, codice_trasmittente, progressivo_invio, codice_destinatario,
        ...
        try:
            quantita = float(quantita)  # Convert quantities to float
        ...
        id_trasmittente_elem = ET.SubElement(dati_trasmissione, 'IdTrasmittente')
        ET.SubElement(id_trasmittente_elem, 'IdPaese').text = 'IT'
        ET.SubElement(id_trasmittente_elem, 'IdCodice').text = id_trasmittente
