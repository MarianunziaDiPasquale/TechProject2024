...
def load_icons():
    ...
    return icon1, icon2, icon3, icon4, icon5, icon6, icon7, icon8, icon9

def create_side_panel_buttons(side_panel, toggle_side_panel, update_dashboard):
    icon1, icon2, icon3, icon4, icon5, icon6, icon7, icon8, icon9 = load_icons()

    button_width = 150  # Set a fixed width for all buttons
    button_padding_x = 8 # Set the padding for both sides of the button
    ...
    button_dashboard2 = ctk.CTkButton(side_panel, text="Categorie", image=icon2, compound="left",
                                      ...
                                      corner_radius=5, anchor="w",font=('Arial', 11), height=15, width=110)
